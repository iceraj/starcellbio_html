...
scb.ui.static.FacsView.scb_f_facs_select_lysate_type = function (element, event) {
    ...
    if (lane_id == '') {
        ...
        while (i--) {
            ...
            _.each(parsed.assignment.template.facs_kinds, function (x) {
                keys_list = keys_list.concat(_.keys(x.conditions));
            });
...
scb.ui.FacsView = function scb_ui_FacsView(gstate) {
    ...
    self.show = function (state) {
        ...
        if (kind == 'analyze') {
            ...
            $('.scb_s_western_blot_progress_gray_bar').children().each(function () {
